...
# To be able to add the services
    with open(file=''C \\Users\\PycharmProjects\\DrugPredictionBasedOnSentimentAnalysisOfReviews\\dataset\\drugsComTrain_raw csv' mode='r' encoding="utf8") as file
